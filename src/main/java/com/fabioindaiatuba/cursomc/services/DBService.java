...
import com.fabioindaiatuba.cursomc.domain.ItemPedido;
import com.fabioindaiatuba.cursomc.domain.Pagamento;
import com.fabioindaiatuba.cursomc.domain.PagamentoComBoleto;
import com.fabioindaiatuba.cursomc.domain.PagamentoComCartao;
...
import com.fabioindaiatuba.cursomc.repositories.EstadoRepository;
...
import com.fabioindaiatuba.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		cat1.getProdutos().addAll(Arrays.asList(p12, 
		...
		produtoRepository.save(Arrays.asList(p12, 
				p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24,
				p25, p26, p27, p28, p29, p30, p31, p32, p33, p34, p35, p36,
				p37, p38, p39, p40, p41, p42, p43, p44, p45, p46, p47, p48, p49, p50));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "fabioindaiatuba@outlook.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana costa", "fabioindaiatuba@bol.com.br", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENTENDE, ped2, sdf.parse("20/10/2017 00:00"), null);
